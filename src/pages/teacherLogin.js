    ...
    loginUser = async (e) => {
        try{
            ...
            localStorage.setItem('easystudy-user', JSON.stringify({
                ...
                phoneNumber: docs.docs[0].data()['phoneNumber'],
                type: 'teacher',
                uid,
                subjects: docs.docs[0].data()['subjects'],
                classes: docs.docs[0].data()['classes']
            }))
            this.props.initiateLoading(false)
...
export default connect(null, actions)(TeacherLogin);
