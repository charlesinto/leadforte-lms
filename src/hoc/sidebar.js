...
renderUserAvatar = () => {
  ...
  render() {
    return (
        <div class="mdk-drawer  js-mdk-drawer" id="default-drawer" data-lign="start" data-position="left" data-domfactory-upgraded="mdk-drawer" data-persistent="" data-opened="">
        <div className="mdk-drawer__content">
            <div className="sidebar sidebar-light sidebar-left bg-white" data-perfect-scrollbar>
    ...
    <small className="text-muted text-uppercase">{this.renderUserType()}</small>
                            </span>
                        </Link>
...
<li className={`sidebar-menu-item ${this.props.activeLink === 'studentDashboard' ? 'active': ''} `}>
...
{/* <li className="sidebar-menu-item">
    <a className="sidebar-menu-button" href="student-series.html">
        <span className="sidebar-menu-icon sidebar-menu-icon--left">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
        ...
        <span className="sidebar-menu-text">Series</span>
    </a>
</li> */}

<li className={`sidebar-menu-item ${this.props.activeLink === 'studentCourses' ? 'active': ''} `}>
    <Link className="sidebar-menu-button" to="/student/courses">
        <span className="sidebar-menu-icon sidebar-menu-icon--left">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
        ...
        <span className="sidebar-menu-text">Subjects</span>
    </Link>
</li>
...
{/* <li className="sidebar-menu-item">
    <a className="sidebar-menu-button" href="student-course.html">
        ...
        <span className="sidebar-menu-text">Course Lessons</span>
    </a>
</li> */}
...
{/* <li className="sidebar-menu-item">
    <a className="sidebar-menu-button" href="student-billing.html">
        <span className="sidebar-menu-icon sidebar-menu-icon--left">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
        ...
        <span className="sidebar-menu-text">Billing</span>
    </a>
</li> */}


{/* <li className="sidebar-menu-item">
    <a className="sidebar-menu-button" href="student-edit-account.html">
        <span className="sidebar-menu-icon sidebar-menu-icon--left">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
...
{/* <li className="sidebar-menu-item">
    <a className="sidebar-menu-button" href="student-profile.html">
        <span className="sidebar-menu-icon sidebar-menu-icon--left">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
        ...
        <span className="sidebar-menu-text">Log Out</span>
...

                    {
                        this.renderUserType() !== 'student' ? (
                            ...
                            <ul className="sidebar-menu mt-0">
                            <li  className={`sidebar-menu-item ${this.props.activeLink === 'classroom' ? 'active': ''} `}>
                                <Link to="/instructor/classroom" className="sidebar-menu-button">
                                    <span className="sidebar-menu-icon sidebar-menu-icon--left">
                                    <i class="fas fa-users"></i>
                                    </span>
                                    <span className="sidebar-menu-text">Collaboration</span>
                            ...
                            {/* <li  className={`sidebar-menu-item ${this.props.activeLink === 'assessments' ? 'active': ''} `}>
                                <Link to="/instructor/view-assessments" className="sidebar-menu-button">
                                    <span className="sidebar-menu-icon sidebar-menu-icon--left">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                            <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                            ...
                            <li className={`sidebar-menu-item ${this.props.activeLink === 'teacherAnnoucement' ? 'active': ''} `}>
                                <Link className="sidebar-menu-button" to="/instructor/view-annoucements">
                                    <span className="sidebar-menu-icon sidebar-menu-icon--left">
                        ...
                        {/* <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="instructor-course-edit.html">
                                <span className="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        {/* <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="instructor-lesson-edit.html">
                                <span className="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                ...
                                <span className="sidebar-menu-text">Edit Lesson</span>
                            </a>
                        </li> */}
                        ...
                        {/* <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="instructor-create-quiz.html">
                                <span className="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                ...
                                <span className="sidebar-menu-text">Create Quiz</span>
                            </a>
                        </li> */}
                        ...
                        {/* <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="instructor-profile.html">
                                <span className="sidebar-menu-icon sidebar-menu-icon--left material-icons">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                        ...
                        {/* <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="instructor-payout.html">
                                <span className="sidebar-menu-icon sidebar-menu-icon--left">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                                        <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                ...
                                <span className="sidebar-menu-text">Payout</span>
                            </a>
                        </li> */}
                ...
                {/* <div className="sidebar-block p-0">
                    <ul className="sidebar-menu" id="components_menu">
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-buttons.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">mouse</i>
                                <span className="sidebar-menu-text">Buttons</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-alerts.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">notifications</i>
                                <span className="sidebar-menu-text">Alerts</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-avatars.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">person</i>
                                <span className="sidebar-menu-text">Avatars</span>
                                <span className="badge badge-primary ml-auto">NEW</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-modals.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">aspect_ratio</i>
                                <span className="sidebar-menu-text">Modals</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-charts.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">pie_chart_outlined</i>
                                <span className="sidebar-menu-text">Charts</span>
                                <span className="badge badge-warning ml-auto">PRO</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-icons.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">brush</i>
                                <span className="sidebar-menu-text">Icons</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-forms.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">text_format</i>
                                <span className="sidebar-menu-text">Forms</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-range-sliders.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">tune</i>
                                <span className="sidebar-menu-text">Range Sliders</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-datetime.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">event_available</i>
                                <span className="sidebar-menu-text">Time &amp; Date</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-tables.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">dns</i>
                                <span className="sidebar-menu-text">Tables</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-tabs.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">tab</i>
                                <span className="sidebar-menu-text">Tabs</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-loaders.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">refresh</i>
                                <span className="sidebar-menu-text">Loaders</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-drag.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">control_point</i>
                                <span className="sidebar-menu-text">Drag &amp; Drop</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-pagination.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">last_page</i>
                                <span className="sidebar-menu-text">Pagination</span>
                            </a>
                        </li>
                        <li className="sidebar-menu-item">
                            <a className="sidebar-menu-button" href="ui-vector-maps.html">
                                <i className="sidebar-menu-icon sidebar-menu-icon--left material-icons">location_on</i>
                                <span className="sidebar-menu-text">Vector Maps</span>
                            </a>
                        </li>
                    </ul>

                    <div className="sidebar-p-a sidebar-b-y bg-light">
                        <div className="d-flex align-items-top mb-2">
                            <div className="sidebar-heading m-0 p-0 flex text-body js-text-body">Progress</div>
                            <div className="font-weight-bold text-muted">60%</div>
                        </div>
