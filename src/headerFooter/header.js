                ...
                <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-primary pl-md-0 pr-0" id="navbar" data-primary>
                    <div class="container-fluid pr-0 ">
                        ...
                        <div class="d-flex sidebar-account flex-shrink-0 mr-auto mr-lg-0">
                            <Link to="/" class="flex d-flex align-items-center text-underline-0">
                                <span class="mr-1  text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="30" height="30">
                                ...
                                <span class="flex d-flex flex-column text-white">
                                    <strong class="sidebar-brand">Easy Study PS</strong>
                                </span>
                            </Link>
                        </div>
                        ...
                        <ul class="ml-auto nav navbar-nav mr-2 d-none d-lg-flex">
                            <li class="nav-item"><Link to="#" class="nav-link">Get Help</Link></li>
                        </ul>
                                    ...
                                    <div class="navbar-notifications-menu__content" data-perfect-scrollbar>
                                        <div class="py-2">
                                            ...
                                            <div class="dropdown-item d-flex">
                                                ...
                                                <div class="flex">
                                                    <Link to="#">A.Demian</Link> left a comment on <Link to="#">Stack</Link><br />
                                            ...
                                            <div class="dropdown-item d-flex">
                                                ...
                                                <div class="flex">
                                                    New user <Link to="#">Peter Parker</Link> signed up.<br />
                                            ...
                                            <div class="dropdown-item d-flex">
                                                ...
                                                <div class="flex">
                                                    <Link to="#">Big Joe</Link> <small class="text-muted">wrote:</small><br />
                                            ...
                                            <div class="dropdown-item d-flex">
                                                ...
                                                <div class="flex">
                                                    <Link to="#">A.Demian</Link> left a comment on <a href="">Stack</a><br />
                                                    <small class="text-muted">1 minute ago</small>
                                                </div>
                                            </div>
                                            <div class="dropdown-item d-flex">
                        ...
                        <div class="dropdown">
                            <Link to="#" class="dropdown-toggle navbar-toggler navbar-toggler-dashboard border-left d-flex align-items-center ml-navbar" data-toggle="dropdown">
                                <img src={process.env.PUBLIC_URL+ "/assets/images/avatar/demi.png"} class="rounded-circle" width="32" alt="Frontted" />
                                <span class="ml-1 d-flex-inline">
                        <span class="text-light">{this.renderUserName()}</span>
                                </span>
                            </Link>
                        ...
                        <small class="text-muted text-uppercase">{this.renderUserType()}</small>
                                    </span>
