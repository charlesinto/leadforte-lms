...
class Course extends Component {
    ...
    render(){
        return (
            <div  style={{cursor:'pointer'}} onClick={(e) => this.goToCourseDetail(e, this.props.id)} className="col-lg-3 col-md-4 card-group-row__col" key={this.props.id}>
            <div className="card card-group-row__card ">
                <div className="card-body d-flex flex-column">
                    <div className="avatar mb-2">
                        <span className="bg-soft-purple avatar-title rounded-circle text-center text-purple">
                            <img src={book} className="mb-3" style={{width: 34}} alt='book' />
