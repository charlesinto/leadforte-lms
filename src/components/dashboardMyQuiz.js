...
class DashboardMyQuiz extends Component{
    render(){
        return (
            <li className="list-group-item">
                                <div className="media align-items-center">
                                    <div className="media-left text-light-gray mr-2">
                                    ...
                                    <div className="media-body">
                                        <Link className="text-body mb-1" href="#"><strong>Level 1 HTML</strong></Link><br />
                                        <div className="d-flex align-items-center">
                                            ...
                                            <Link to="take-course.html" className="small">Basics of HTML</Link>
                                        </div>
                                    </div>
...
export default DashboardMyQuiz;