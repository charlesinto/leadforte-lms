...
class DashboardFeaturedCourse extends Component {
    render(){
        return (
            <div className="col-lg-3 col-md-4 card-group-row__col" key={this.props.id}>
...
export default DashboardFeaturedCourse