...
class Assessments extends Component {
    goToCourseDetail = (e, id) => {
        this.props.goToAssessment(id)
    }
  render() {
    return (
        <div key={this.props.id}  style={{cursor:'pointer'}} onClick={(e) => this.goToCourseDetail(e, this.props.id)} className="col-md-4 card-group-row__col" key={this.props.id}>
            ...
            <div className="card-body d-flex">
                ...
                <div className="d-flex flex-column">
                    <div className="mb-3 d-flex flex-column">
                        <Link onClick={(e) => this.goToCourseDetail(e, this.props.id)}  className="text-dark mb-2">
